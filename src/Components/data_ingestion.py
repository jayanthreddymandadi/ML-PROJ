...
from src.exception import exception   # Custom exception class for better error handling
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            data_csv_path = PROJECT_ROOT / 'rawdata' / 'Traffic_Accident_Severity_Dataset.csv'
